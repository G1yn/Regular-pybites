...
def create_parser():
    ...
    my_parser = argparse.ArgumentParser(description= 'Calculate your BMI.')
    my_parser.add_argument('-w', '--weight', metavar= 'WEIGHT', help= 'Your weight in kg')
    my_parser.add_argument('-l', '--length', metavar= 'LENGTH',  help= 'Your length in cm')
